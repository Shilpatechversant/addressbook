<cfcomponent name="login" persistent="true">
    <cffunction name="loginAction" access="remote">
        ...
        <cfargument name="password" type="string" required="true">
            ...
            <cfquery datasource="newtech" result="outputdata" name="loginResult"> SELECT * FROM coldfusion.login WHERE username= <cfqueryparam CFSQLType="cf_sql_varchar" value="#arguments.username#"> AND password= <cfqueryparam CFSQLType="cf_sql_varchar" value="#hash(arguments.passWord,'SHA')#"> AND status="1" </cfquery>
